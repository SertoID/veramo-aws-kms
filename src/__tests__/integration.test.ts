import { KeyManagementSystem, KeyManagementSystemOptions } from '../key-management-system'
import { IKey, TKeyType } from '@veramo/core'

const awsApiOptions : KeyManagementSystemOptions = {
  region: "us-east-2",
...
describe('@veramo/kms-local', () => {
  it('should compute a shared secret Ed+Ed', async () => {
    const kms = new KeyManagementSystem(awsApiOptions)
    const myKey = {
      type: 'Ed25519',
      privateKeyHex:
